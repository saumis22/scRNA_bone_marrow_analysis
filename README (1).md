...
This repository contains a complete single-cell RNA-sequencing analysis workflow for identifying cell types, inferring tissue origin, and characterizing immune status in an unlabeled human dataset. The analysis follows standard single-cell best practices using Scanpy, including preprocessing, dimensionality reduction, clustering, marker-based annotation, and lineage-specific interpretation.

All improvements requested in the project feedback—including more precise methodology, reproducibility instructions, expanded tissue justification, statistical caveats, and detailed documentation—have been incorporated.

**1\. Objectives**

* Identify significant immune and hematopoietic cell populations from the dataset.  
...
If your dataset is different, update data\_path in the notebook.
...
* Marker detection (rank\_genes\_groups): \~1 minute
...
* Top markers from sc.tl.rank\_genes\_groups (log1p-normalized).  
...
| 6 | Megakaryocytes / Platelet Lineage |
| 7 | Plasma Cells |
...
* Dominance of T, B, NK, and monocyte populations is typical of PBMC.  
